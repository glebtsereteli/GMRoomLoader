...
GMRoomLoader is a pure GML [FOSS](https://en.wikipedia.org/wiki/Free_and_open-source_software) GameMaker library for creating room prefabs and loading room contents at runtime.
