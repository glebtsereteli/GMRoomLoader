...
function RoomLoaderReturnData(_room) constructor {
	...
	static get_layer = function(_name) {
		__RoomLoaderCatchString(__messagePrefix, "get_layer", _name, "get a Layer ID from the", "name");
	...
	static get_tilemap = function(_layer_name) {
		__RoomLoaderCatchString(__messagePrefix, "get_tilemap", _layer_name, "get a Tilemap ID from the", "layer name");
	...
	*/
	...
	static get_sequence = function(_name) {
		__RoomLoaderCatchString(__messagePrefix, "get_sequence", _name, "get a Sequence ID from the", "name");
	...
	static get_background = function(_layer_name) {
		__RoomLoaderCatchString(__messagePrefix, "get_background", _layer_name, "get a Background ID from the", "layer name");
	...
	static cleanup = function(_destroy_layers = true) {
		...
		if (__cleaned_up) {
			__RoomLoaderLogMethod(__messagePrefix, _method_name, $"data for \<{room_get_name(__room)}\> is already cleaned up");
			return;
		}
		...
		__RoomLoaderLogMethodTimed(__messagePrefix, _method_name, _bench_message, __room);
	};
